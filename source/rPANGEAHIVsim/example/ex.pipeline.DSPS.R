...
tmpdir			<- '/Users/Oliver/git/HPTN071sim/tmp140911'
...
pipeline.args	<- rPANGEAHIVsim.pipeline.args( yr.start=1980, yr.end=2020, seed=42, s.PREV.min=0.01, s.PREV.max=0.25, epi.model='DSPS', epi.dt=1/48, epi.import=0.1 )	
